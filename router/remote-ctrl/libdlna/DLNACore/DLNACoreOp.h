...
public:
	...
	public:
#ifdef _REMOTE_DLNA_
		virtual void onDLNAProgressiveBrowseOpResult(DLNAProgressiveBrowseOp *op, NPT_UInt32 startingIndex, NPT_UInt32 numberReturned, NPT_UInt32 totalMatches, const DLNAObjectList& ls, const NPT_String& requestFrom) = 0;
#endif
