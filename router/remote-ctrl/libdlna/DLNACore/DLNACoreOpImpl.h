...
#ifdef _REMOTE_DLNA_
	void notifyBrowseResult(const NPT_String& requestFrom, NPT_UInt32 startingIndex, NPT_UInt32 numberReturned, NPT_UInt32 totalMatches, const DLNAObjectList& ls);
#endif
...
public:
#ifdef _REMOTE_DLNA_
	DLNAFullBrowseTask(const NPT_String& requestFrom, DLNAFullBrowseOpImpl *op, ControlPoint *cp, const UUID& mediaServerUuid, const NPT_String& cdsId, const NPT_String& containerId, NPT_UInt32 requestedCount = 20);
