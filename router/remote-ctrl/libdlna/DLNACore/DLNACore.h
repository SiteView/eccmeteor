...
#ifdef _REMOTE_DLNA_
	NPT_Result browseMediaServerEx(const NPT_String& requestFrom, const UUID& mediaServerUuid, const NPT_String& containerId, int step, DLNAProgressiveBrowseOp::ResultCallback *resultCallback, DLNAProgressiveBrowseOp **op);
#endif
