...
#ifdef _REMOTE_DLNA_
	NPT_Result browseMediaServerEx(const NPT_String& requestFrom, const UUID& mediaServerUuid, const NPT_String& containerId, NPT_UInt32 step, DLNAProgressiveBrowseOp::ResultCallback *resultCallback, DLNAProgressiveBrowseOp **op);
