...
namespace SV
{
	...
	SV_API int GetUnivData(ForestMap & fmap, const NodeData & inwhat, string & estr)
	{
		...
		else if(what.compare("GetCommonData")==0)
		{
			...
			if(type.compare("svse")==0)
				return OF::QuerySVSE(fmap, inwhat, estr);
			else if(type.compare("group")==0)
				return OF::QueryGroup(fmap, inwhat, estr);
			else if(type.compare("entity")==0)
				return OF::QueryEntity(fmap, inwhat, estr);
			else if(type.compare("monitor")==0)
				return OF::QueryMonitor(fmap, inwhat, estr);
			else
			{
				estr+= " 没有有效的 type  ";
				return false;
		...
		{
			return OF::WriteOrDelIniFileData(0, fmap, inwhat, estr);
		}
		else if(what.compare("DeleteIniFileData")==0)
		{
			return OF::WriteOrDelIniFileData(1, fmap, inwhat, estr);
		}	
		else if(what.compare("DeleteIniFileKeys")==0)
		{
			return OF::WriteOrDelIniFileData(2, fmap, inwhat, estr);
		}
		...
		else if(what.compare("TryLogin")==0)
		{
			...
			try{
				ret=OF::TryToLogin(fmap, inwhat, estr, isTrial);
			}
			catch(...)
			{
				ret=false;
		...
		{
			return OF::encrypt(fmap, inwhat, estr);
		}
		else if(what.compare("decrypt")==0)
		{
			return OF::decrypt(fmap, inwhat, estr);
		}
		else if(what.compare("MonitorCopy")==0)
		{
			...
			if( !OF::CheckMonitorBelongToETpl(sourceId,targetParentId,estr) )
			{
			...
			if(!OF::CanAddMorePoint(targetParentId,estr,"monitor"))
			{
				PutReturnForestMap( fmap,"return","return","false" );
				return false;
			}
		...
		else if(what.compare("EntityCopy")==0)
		{
			...
			if(!OF::CanAddMorePoint(sourceId,estr))
			{
				PutReturnForestMap( fmap,"return","return","false" );
				return false;
			}
		...
		else if(what.compare("GetCiInstance")==0)
		{
			...
			return OF::QueryEntity(fmap, inwhat2, estr);
		}
		else if(what.compare("GetJobInstance")==0)
		{
			...
			NodeData inwhat2;
			PutValueInNodeData(inwhat2,"id",sv_id);
			return OF::QueryMonitor(fmap, inwhat2, estr);
		}
		...
		{
			return OF::GetDynamicData(fmap,inwhat,estr);
		}
		else if(what.compare("RefreshMonitors")==0)
		{
			return OF::RefreshMonitors(fmap,inwhat,estr);
		}
		else if(what.compare("GetLatestRefresh")==0)
		{
			return OF::GetLatestRefresh(fmap,inwhat,estr);
		}
		else if(what.compare("GetRefreshed")==0)
		{
			return OF::GetRefreshed(fmap,inwhat,estr);
		}
		else if(what.compare("TestEntity")==0)
		{
			return OF::TestEntity(fmap,inwhat,estr);
		}
		else if(what.compare("GetEntityDynamicData")==0)
		{
			return OF::GetEntityDynamicData(fmap,inwhat,estr);
		}
		else if(what.compare("QueryReportData")==0)
		{
			bool ret(false);
			try{
				ret= OF::QueryReportData(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("QueryAllMonitorInfo")==0)
		{
			bool ret(false);
			try{
				ret= OF::QueryAllMonitorInfo(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("QueryInfo")==0)
		{
			bool ret(false);
			try{
				ret= OF::QueryInfo(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("SmsTest")==0)
		{
			bool ret(false);
			try{
				ret= OF::SmsTest(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("EmailTest")==0)
		{
			bool ret(false);
			try{
				ret= OF::EmailTest(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("SmsTestByDll")==0)
		{
			bool ret(false);
			try{
				ret= OF::SmsTestByDll(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("DeleteRecords")==0)
		{
			bool ret(false);
			try{
				ret= OF::DeleteRecords(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("GetAllView")==0)
		{
			bool ret(false);
			try{
				ret= OF::GetAllView(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("AddView")==0)
		{
			bool ret(false);
			try{
				ret= OF::AddView(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("DeleteView")==0)
		{
			bool ret(false);
			try{
				ret= OF::DeleteView(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("DeleteViewItem")==0)
		{
			bool ret(false);
			try{
				ret= OF::DeleteViewItem(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
	...
	SV_API int GetForestData(ForestList & flist, const NodeData & inwhat, string & estr)
	{
		string what=GetValueInNodeData(inwhat,"dowhat",estr);
		if(what.empty())
			return false;
		...
		if(what.compare("GetTreeData")==0)
		{
			...
			try{
				...
				OF::SetChildSumForestData(flist, inwhat, estr);
				OF::SetBeyondLicenseForestData(flist);
				if( ret && !(LoginName.empty()) )
					return OF::FilterForestData(flist, inwhat, estr);
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("GetTreeData2")==0)
		{
			...
			bool ret(false);
			try{
				ret= OF::GetTreeData2(flist, inwhat, estr);
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("QueryRecordsByTime")==0)
		{
			bool ret(false);
			try{
				ret= OF::QueryRecordsByTime(flist, inwhat, estr);
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("QueryRecordsByCount")==0)
		{
			bool ret(false);
			try{
				ret= OF::QueryRecordsByCount(flist, inwhat, estr);
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("QueryAlertLog")==0)
		{
			bool ret(false);
			try{
				ret= OF::QueryAlertLog(flist, inwhat, estr);
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("GetViewData")==0)
		{
			bool ret(false);
			try{
				ret= OF::GetViewData(flist, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
	...
	SV_API int SubmitUnivData(ForestMap & fmap, const NodeData & inwhat, string & estr)
	{
		string what=GetValueInNodeData(inwhat,"dowhat",estr);
		if(what.empty())
			return false;
		...
		else if(what.compare("SubmitEntity")==0)
		{
			...
			{
				id.clear();
				if( OF::CanAddMorePoint(sv_devicetype, estr, "addOneEntity") )
				{
					obj= CreateEntity();
			...
			else
			{
				if(!newone)
				{
					...
					if( strdel.empty() || ( OF::CheckNetWork(sv_devicetype) != OF::CheckNetWork(strdel) ) )
					{
						fmap.clear();
						PutReturnForestMap( fmap,"return","return","false" );
				...
				OF::TryDecryptValue(fmap1, "property", "entity",  estr, false);
		...
		else if(what.compare("SubmitMonitor")==0)
		{
			...
			if(id.empty())
			{
				...
				belong= OF::CheckMonitorBelongToETpl("",parentid,estr, sv_monitortype);
			}
			else
			{
				cout<<"  id: "<<id.c_str()<<"  sv_monitortype:  "<<sv_monitortype.c_str()<<endl;
				belong= OF::CheckMonitorBelongToETpl(id,"",estr, sv_monitortype);
			}
			...
			{
				id.clear();
				if( OF::CanAddMorePoint(parentid, estr, "monitor") )
				{
					obj= CreateMonitor();
			...
			{
				ForestMap & fmap1= const_cast< ForestMap & >( fmap );
				OF::TryDecryptValue(fmap1, "parameter",			"monitor",  estr, false);
				OF::TryDecryptValue(fmap1, "advance_parameter", "monitor",  estr, false);
		...
		else if(what.compare("AddManyMonitor")==0)
		{
			bool ret(false);
			try{
				ret= OF::AddManyMonitor(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("AdvanceAddManyMonitor")==0)
		{
			bool ret(false);
			try{
				ret= OF::AdvaceAddManyMonitor(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("AddViewItem")==0)
		{
			bool ret(false);
			try{
				ret= OF::AddViewItem(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("SetValueInManyMonitor")==0)
		{
			bool ret(false);
			try{
				ret= OF::SetValueInManyMonitor(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("AppendOperateLog")==0)
		{
			bool ret(false);
			try{
				ret= OF::AppendOperateLog(fmap, inwhat, estr);	
			}
			catch(...)
			{
				ret=false;
		...
		else if(what.compare("SubmitJobInstance")==0)
		{
			...
			bool belong= OF::CheckMonitorBelongToETpl("",entity_id,estr, sv_monitortype);
			if( !belong )
			{
				fmap.clear();
				estr+= " This node's sv_monitortype doesn't belong to its parent's sv_devicetype.  ";
	...
	//删除字符串前后的空格
	SV_API std::string TrimSpace(const std::string & input)
	{
		string ret=input;
		try{
	...
	//在 ForestMap 中查找值
	SV_API string GetValueInForestMap(const ForestMap & fmap, string section, string key, string & estr )
	{
