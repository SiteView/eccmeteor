...
#ifndef _SV_ECC_SNMPOPRATE_H_
#define _SV_ECC_SNMPOPRATE_H_
...
int GetPrivateProfileString1(const char * m_AppName, const char * m_KeyName, const char * m_default, char * m_Ret, int size, const char * m_FileName);
std::string FuncGetProfileStringBy(const char * m_AppName, const char * m_KeyName, const char * m_FileName);
