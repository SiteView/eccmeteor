...
public:
	...
	void SetEntity(Entitys*pEntity)
	{
		m_pEntity=pEntity;
	}

	Entitys * GetEntity(void)
	{
		return m_pEntity;
	}
	...
	Monitors *GetGroupDependMonitor(void)
	{
		return m_GroupDependMonitor;
	}

	void SetGroupDependMonitor(Monitors *pMonitor)
	{
...
private:
	...
	Monitors *m_GroupDependMonitor;
};

typedef std::list<Monitors *>  CMonitorList;
