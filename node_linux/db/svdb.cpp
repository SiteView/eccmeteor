...
void testgeneralpool(void)
{
	...
	printf("the int value:%d,the stirng value:%s,str2 is:%s,the 产品:%s\n", gp.GetInt("myint", "intkey", 0),
			(char *) gp.GetString("mystring", "stringkey"), (char *) gp.GetString("mystring", "str2"),
			(char *) gp.GetString("游龙科技网络有限公司", "产品"));

	printf("intkey type:%d,datakey type:%d,str2 type:%d\n", gp.GetValueTypeBySectionAndKey("myint", "intkey"),
			gp.GetValueTypeBySectionAndKey("data", "datakey"), gp.GetValueTypeBySectionAndKey("mystring", "str2"));
...
void testdbquerydyn()
{
	...
	printf("Create time :%s,state:%d,keepstatetime:%d,keeptimes:%d,displaystr:%s\n", dyn.m_time.Format().c_str(),
			dyn.m_state, dyn.m_keeplaststatetime.GetTotalMinutes(), dyn.m_laststatekeeptimes, dyn.m_displaystr);
...
void testquerydbrecord(string table)
{
	...
	for (int i = 0; i < count; i++)
	{
		...
		printf("Record: craeate time:%s,state:%d,datalen:%dintvalue:%d,strvalue:%s,floatvalue:%0.2f\n",
				prht->createtime.Format().c_str(), prht->state, prht->datalen, iv, sv.c_str(), fv);
...
void InsertRecord()
{
	...
	for (int i = 0; i < 234; i++)
	{
		...
		sprintf(buf,
				"<++++++++这是第%d条数据,测试大数据,原则上数据可以无限制增长,北京游龙科技网络有限公司,原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司原则上数据可以无限制增长,北京游龙科技网络有限公司+++++++++>",
				i);
...
void testqueuerecord(void)
{
	...
	printf("label:%s,ctime:%s,data:%s\n", prd->GetLabel().c_str(), prd->GetCreateTime().Format().c_str(),
			prd->GetData());
...
#define LOCKFILE "/var/run/svdb.pid"
...
bool tryGetAllResourceInfo(void)
{
	...
	S_UINT len = 0;
	char *pdata = NULL;
	bool ret = qd.Query(&querybuf, (void **) &pdata, len, "127.0.0.1");
	if (pdata != NULL)
		delete[] pdata;
...
#else
	char tempchar[128] = { 0 };
	if (hasrun() || tryGetAllResourceInfo())
#endif
	{
...
//	cout<<fname.c_str()<<endl;
	string text = " svdb closed at " + svutil::TTime::GetCurrentTimeEx().Format();
	std::ofstream output(fname.c_str(), ios::app);
	if (output)
		output << IdcUser::ProcessID << text.c_str() << endl;
	AddToErrorLog(text.c_str());
	cout << "\n\n----------------------------------------------" << endl;
...
{
	puts("\nstart svdb as daemon...\n");
	outputRegeditKey();
	cout << "    linux .pid is: " << LOCKFILE << endl;
	cout << "    stop svdb by command: svdb -stop\n" << endl;
	daemonize();
	if (!Run())
	{
