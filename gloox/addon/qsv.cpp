...
std::string testSubmitGroup()
{
	...
	StrMap gdata;
	gdata.insert(std::make_pair("sv_name", "xmpp_测试"));
	gdata.insert(std::make_pair("sv_description", "xmpp_测试"));
