	...
	value:function(type,template){
		...
		switch(type){
			...
			case "group" : templateName  = "UserPromissionTypeOfGroup";
				break;
			case "alert" : templateName  = "UserPromissionTypeOfAlert";
				break;
			...
			case "AlertPlan" :templateName = "UserPromissionTypeOfAlertStrategy";
				break;
			case "report" : templateName = "UserPromissionTypeOfReport";
				break;
			case "statistical" : templateName = "UserPromissionTypeOfStatisticsReport";
				break;
			case "trend" : templateName = "UserPromissionTypeOfTrendReport";
				break;
			case "topN" : templateName = "UserPromissionTypeOfTopNReport";
				break;
			case "statusStatistical" : templateName = "UserPromissionTypeOfStatusStatisticalReport";
				break;
			case "contrast" : templateName = "UserPromissionTypeOfContrastReport";
				break;
			case "operationAndMaintenance" : templateName = "UserPromissionTypeOfOperationAndMaintenanceReport";
				break;
			case "timeconstrastreport" : templateName = "UserPromissionTypeOfTimeConstrastReport";
				break;
			case "monitorInfo" : templateName = "UserPromissionTypeOfMonitorInfoReport";
				break;
			case "SysLogQuery" : templateName = "UserPromissionTypeOfSysLogQueryReport";
				break;
			case "setting" : templateName = "UserPromissionTypeOfSetting";
				break;
			case "BasicSetting" : templateName = "UserPromissionTypeOfBasicSetting";
				break;
			case "EmailSetting" : templateName = "UserPromissionTypeOfEmailSetting";
				break;
			case "MessageSetting" : templateName = "UserPromissionTypeOfMessageSetting";
				break;
			case "UserSetting" : templateName = "UserPromissionTypeOfUserSetting";
				break;
			case "SysLogsetting" : templateName = "UserPromissionTypeOfSysLogsetting";
				break;
			case "task" : templateName = "UserPromissionTypeOftask";
				break;
			case "taskabsolute" : templateName = "UserPromissionTypeOftaskabsolute";
				break;
			case "taskperiod" : templateName = "UserPromissionTypeOftaskperiod";
				break;
			case "TaskRelative" : templateName = "UserPromissionTypeOfTaskRelative";
				break;
			case "OperateLog" : templateName = "UserPromissionTypeOfOperateLog";
				break;
			case "SysLogsetting" : templateName = "UserPromissionTypeOfSysLogsetting";
				break;
			case "SystemDiagnosis" : templateName = "UserPromissionTypeOfSystemDiagnosis";
				break;
			case "License" : templateName = "UserPromissionTypeOfLicense";
				break;
			case "About" : templateName = "UserPromissionTypeOfAbout";
				break;
		}
		if(templateName !== ""){
