...
*点击查询按钮开始查询
*/
Template.statistical_add_rMenu.events = 
{
...
*查询结果数据列表
*/
Template.statistical_add_rMenu.monitorInforesultlist = function()
{
...
Template.statistical_add_rMenu.rendered = function()
{	
	//绘制监视器树视图
	drawMonitorTree();
...
*查询结果数据列表
*/
Template.statistical_add_rMenu.monitortemplates = function()
{
...
*查询结果数据列表
*/
Template.statistical_add_rMenu.monitorreturns = function()
{
