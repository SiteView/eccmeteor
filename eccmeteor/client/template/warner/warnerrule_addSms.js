Template.warnerruleofmessage.events={
	...
	"click #warnerruleofmessagesavebtn":function(e,t){
		...
		var targets = [];
		var arr = $.fn.zTree.getZTreeObj("svse_tree_check_addsms").getNodesByFilter(function(node){return (node.checked && node.type === "monitor")});
		//console.log(arr);
		for(index in arr){
...
Template.warnerruleofmessage.rendered = function(){
	...
	$(function(){
		...
		var treeObj = $.fn.zTree.init($("#svse_tree_check_addsms"), setting, data);
