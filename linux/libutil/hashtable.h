...
namespace svutil{
	...
	/*	void pushnext(const KEY_ &key,const VALUE_ &value)
		...
		void Debug_print(void)
		{
			...
			if(count>0)
				m_otherelements.inorder(&hashelement<KEY_,VALUE_>::printelement);
	...
	public:
		...
		public:
			iterator()
			{
				svutil::hiterator<HELEMENT >::m_pos=-1;
				svutil::hiterator<HELEMENT >::m_element=NULL;
				svutil::hiterator<HELEMENT >::m_intree=false;
			}
			iterator(const iterator &hi)
			{
				svutil::hiterator<HELEMENT >::m_pos=hi.m_pos;
				svutil::hiterator<HELEMENT >::m_element=hi.m_element;
				svutil::hiterator<HELEMENT >::m_intree=hi.m_intree;
			}
			...
			{
				return (*svutil::hiterator<HELEMENT >::m_element);
